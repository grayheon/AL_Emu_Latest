...
void AgpmConfig::SetEnableQuest(BOOL bEnableQuest /* = AGPM_CONFIG_DEFAULT_VALUE_ENABLE_QUEST */)
{
	m_stAgpdConfig.bIsEnableQuest = bEnableQuest;
}

BOOL AgpmConfig::IsEnableQuest()
{
	return m_stAgpdConfig.bIsEnableQuest;
}
...
BOOL AgpmConfig::IsPromotionServer()
{
	return m_stAgpdConfig.bIsPromotionServer;
}

void AgpmConfig::SetPromotionServer( BOOL bIsPromotionServer )
{
	m_stAgpdConfig.bIsPromotionServer = bIsPromotionServer;
}
