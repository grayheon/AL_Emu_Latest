...
#define AGPM_CONFIG_DEFAULT_VALUE_EXP_PENALTY				TRUE			// PC가 죽었을 때 Item Drop 여부
...
#define AGPM_CONFIG_DEFAULT_VALUE_ENABLE_QUEST				TRUE			// QUEST 가능여부
...
struct AgpdConfig
{
	...
	INT32		lDisableChattingRoom;		// 채팅방 기능 제거
...
public:
	...
	// 프로모션서버(육성서버) 여부
	BOOL IsPromotionServer();
	void SetPromotionServer( BOOL bIsPromotionServer );
	...
	//채팅방 온오프 기능
	void SetDisableChattingRoom(INT32 lType) { m_stAgpdConfig.lDisableChattingRoom = lType; }
	INT32 GetDisableChattingRoom() { return m_stAgpdConfig.lDisableChattingRoom; }
