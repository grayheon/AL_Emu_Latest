...
struct PACKET_CHARACTER_IGNORE_STATUS_UPDATE : public PACKET_CHARACTER
{
	...
	PACKET_CHARACTER_IGNORE_STATUS_UPDATE()
	...
	{
		pcOperation		= AGPMCHAR_PACKET_OPERATION_UPDATE_IGNORE_STATUS;
		unPacketLength	= (UINT16)sizeof(PACKET_CHARACTER_IGNORE_STATUS_UPDATE);
	}
};
