...
typedef enum AgpmCharacterPacketOperation {
	...
	AGPMCHAR_PACKET_OPERATION_REQUEST_COUPON,
	AGPMCHAR_PACKET_OPERATION_COUPON_INFO,
	AGPMCHAR_PACKET_OPERATION_REQUEST_COUPON_USE,
	AGPMCHAR_PACKET_OPERATION_ANSWER_COUPON_USE,
	AGPMCHAR_PACKET_OPERATION_UPDATE_IGNORE_STATUS,
...
typedef enum _eAgpmCharacterPenalty {
	...
	AGPMCHAR_PENALTY_ITEMPRICE_DOUBLE,
	AGPMCHAR_PENALTY_CONVERT,
	AGPMCHAR_PENALTY_SKILL_LEARN,
	AGPMCHAR_PENALTY_RIDEABLE,
	AGPMCHAR_PENALTY_AUCTION,
	AGPMCHAR_PENALTY_CHARCUST,
	AGPMCHAR_PENALTY_EXP_LOSE,
	AGPMCHAR_PENALTY_POTAL,
...
typedef enum AgpmCharacterCallbackPoint			// Callback ID in Character Module 
{
	...
	AGPMCHAR_CB_ID_UPDATE_MUKZA_POINT,			//	사용 안함
	...
	AGPMCHAR_CB_ID_REQUEST_COUPON,
	AGPMCHAR_CB_ID_RECIEVE_COUPON_INFO,
	AGPMCHAR_CB_ID_REQUEST_COUPON_USE,
	AGPMCHAR_CB_ID_RECIEVE_COUPON_USE,
	AGPMCHAR_CB_ID_CHECK_TELEPORTBLOCK,
	AGPMCHAR_CB_ID_UPDATE_IGNORE_STATUS
...
#define	AGPMCHAR_EXCEL_COLUMN_MAX_HP		"기본 HP"
#define	AGPMCHAR_EXCEL_COLUMN_MAX_MP		"기본 MP"
#define	AGPMCHAR_EXCEL_COLUMN_MAX_SP		"기본 SP"
#define AGPMCHAR_EXCEL_COLUMN_MAX_AR		"기본 AR"
#define AGPMCHAR_EXCEL_COLUMN_MAX_DR		"기본 DR"
#define	AGPMCHAR_EXCEL_COLUMN_MAX_MAP		"매직 ATK"
#define	AGPMCHAR_EXCEL_COLUMN_DEF_PHY		"기본 AC"
...
#define	AGPMCHAR_EXCEL_COLUMN_MIN_DMG_PHY	"최소 데미지"
#define	AGPMCHAR_EXCEL_COLUMN_MAX_DMG_PHY	"최대 데미지"
...
//////////////////////////////////////////////////////////////////////////
// Character Saved Special Status 
// (AgpdCharacter.h에 있는 AGPDCHAR_SPECIAL_STATUS_NORMAL 요 형태의 bit flag와 짝을 이룸)

#define AGPMCHAR_SAVED_SPECIAL_STATUS_VOLUNTEER						"V"			//AGPDCHAR_SPECIAL_STATUS_VOLUNTEER
...
public:
	...
	BOOL					OnOperationRequestCouponInfo(PVOID pvPacket);
	BOOL					OnOperationRecieveCouponInfo(PVOID pvPacket);
	BOOL					OnOperationRequestCouponUse(PVOID pvPacket);
	BOOL					OnOperationAnswerCouponUse(PVOID pvPacket);
...
private:
	...
	BOOL	CheckNameTw(CHAR* pszCharName, int charNameLen);
...
public:
	...
	AuPacket				m_csPacketIgnoreStatus;		// 방어무시 신규옵션
	...
	AgpdMurderPenalty		m_AgpdMurderPenalty;
	...
	BOOL	SetShrineTypifier(AgpdCharacterTemplate *pcsTemplate);//JK_쉬라인머지
	...
	BOOL	IsShrineTypifier(AgpdCharacter *pcsAgpdCharacter); //JK_쉬라인머지
	...
	BOOL	StreamReadMurderPenalty(CHAR *pszFile, BOOL bDecryption);
...
public:
	...
	BOOL	ProcessMovePacket(AgpdCharacter *pcsCharacter, AgpdCharacter *pcsMoveTargetChar, ApdObject *pcsMoveTargetObject, INT32 lMoveFollowDistance,
	...
	BOOL	MoveCharacterFollow(AgpdCharacter *pcsCharacter, AgpdCharacter *pcsTargetCharacter, INT32 lFollowDistance, BOOL bMoveFirst = FALSE, FLOAT *pfDeltaMove = NULL , BOOL bCheckBlock = TRUE );
	BOOL	MoveCharacterFollow(AgpdCharacter *pcsCharacter, ApdObject *pTargetObject, INT32 lFollowDistance, BOOL bMoveFirst = FALSE, FLOAT *pfDeltaMove = NULL , BOOL bCheckBlock = TRUE );
	BOOL	CheckStopFollow(AgpdCharacter *pcsCharacter, AgpdCharacter *pcsTargetCharacter);
	BOOL	CheckStopFollow(AuPOS *pCharacterPos, AuPOS *pTargetPos, INT32 lFollowDistance);
	...
	// bNoSendSelf는 서버에서 셀프캐릭터에게만 보내지 않게 하기 위한 옵션으로 사용한다.
	BOOL	StopCharacter(INT32 lCID, AuPOS *pstPos , BOOL bNoSendSelf = FALSE);
	BOOL	StopCharacter(AgpdCharacter *pcsCharacter, AuPOS *pstPos , BOOL bNoSendSelf = FALSE );
	...
	BOOL	SetCallbackRequestCoupon( ApModuleDefaultCallBack pfCallback, PVOID pClass );
	BOOL	SetCallbackRequestCouponUse( ApModuleDefaultCallBack pfCallback, PVOID pClass );

	BOOL	SetCallBackRecieveCouponInfo( ApModuleDefaultCallBack pfCallback, PVOID pClass );
	BOOL	SetCallBackRecieveCouponUse( ApModuleDefaultCallBack pfCallback, PVOID pClass );

	BOOL	SetCallBackCheckTeleportBlock( ApModuleDefaultCallBack pfCallback, PVOID pClass );

	BOOL	SetCallBackUpdateIgnoreStatus( ApModuleDefaultCallBack pfCallback, PVOID pClass );
	...
	INT32	GetShrineCoin( AgpdCharacter* pcsCharacter );
	...
	UINT32	GetLastUseEscapeTime(AgpdCharacter *pcsCharacter);
	UINT32  SetLastUseEscapeTime(AgpdCharacter *pcsCharacter, UINT32 ulLastUseEscapeTime);
	...
	BOOL	IsHitHeroic(AgpdCharacter *pcsCharacter);
	BOOL	IsHitHeroic(INT32 lCID);
