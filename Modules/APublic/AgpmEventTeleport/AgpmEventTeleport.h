...
#define AGPMTELEPORT_MAX_TELEPORT_POINT			400
#define AGPMTELEPORT_MAX_TELEPORT_GROUP			400
...
typedef enum AgpmEventTeleportCallbackPoint			// Callback ID in Character Module 
{
	...
	AGPMEVENT_TELEPORT_CB_ID_SET_TELEPORTBLOCK,
...
public:
	...
	*/
	...
	BOOL				SetCallbackSetTeleportBlock(ApModuleDefaultCallBack pfCallback, PVOID pClass);
