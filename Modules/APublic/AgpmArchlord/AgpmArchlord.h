...
enum AgpmArchlordPacketOperation
{
	...
	AGPMARCHLORD_OPERATION_NOTICE_NEW_ARCHLORD,
};
...
enum AgpmArchlordCBID
{
	...
	AGPMARCHLORD_CB_NOTICE_NEW_ARCHLORD,
};
...
const INT32	ARCHLORD_SIEGEWAR_START_TIME = 21;
...
public:
	...
	BOOL SetCallbackEventNoticeNewArchlord(ApModuleDefaultCallBack pfCallback, PVOID pClass);
	...
	PVOID MakePacketNoticeNewArchlord(INT16 *pnPacketLength);
