...
typedef enum _eAgpmSystemMessageCode
{
	...
	AGPMSYSTEMMESSAGE_CODE_SHRINEBATTLE_LEVEL_LIMIT			= 47,	// 이 쉬라인에 들어갈수 없는 레벨입니다.		글로벌에 없는 메세지 때문에 47로 건너뜀
	AGPMSYSTEMMESSAGE_CODE_SHRINEBATTLE_PLAYERCOUNT_LIMIT,			// 쉬라인 지역에 입장할 수 있는 최대 인원을 초과하였습니다. 다음 쉬라인 전투에 참여하시기 바랍니다.
	AGPMSYSTEMMESSAGE_CODE_SUMMONS_FAILURE_UPDATE_REGION,			// 소환수가 이동해오지 못했습니다
	AGPMSYSTEMMESSAGE_CODE_ESCAPE_COOL_TIME_LIMIT	= 51,					//탈출 명령어는 1시간마다 사용할수 있습니다.
	AGPMSYSTEMMESSAGE_CODE_ESCAPE_STATE_LIMIT,						//탈출 명령어는 전투중, 이동중에 사용할 수 없습니다.
	AGPMSYSTEMMESSAGE_CODE_SHRINEBATTLE_ERR_MOVE_IN_SIEGE,			// 공성지역에서는 쉬라인으로 이동할 수 없습니다.
