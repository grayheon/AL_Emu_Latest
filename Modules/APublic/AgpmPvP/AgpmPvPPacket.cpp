...
PVOID AgpmPvP::MakePvPInfoPacket(INT16* pnPacketLength, INT32* plCID, INT32* plWin, INT32* plLose, INT8* pcPvPMode, INT8* pcPvPStatus, AgpdPvPADChar::AgpdRacePvPResult *pcsPvPResult, INT32 *plLength)
{
	return MakePvPPacket(pnPacketLength,
					...
					pcPvPMode,
					pcPvPStatus,
					NULL, NULL,	NULL, pcsPvPResult, plLength);
}
