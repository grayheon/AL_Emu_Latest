...
const int AGPDQUEST_MAX_SUMMARY_TEXT	= 256;
...
const int AGPDQUEST_MAX_RESULT_ITEM_SELECTABLE	= 8;
...
struct AgpdQuestInfo
{
	...
	INT32 lLocation;
	BOOL bExistSelectItem;
	BOOL bIsCompleteSummary;
};
...
struct AgpdResult
{
	...
	AgpdElementItem		Selectableitem[AGPDQUEST_MAX_RESULT_ITEM_SELECTABLE];
};
