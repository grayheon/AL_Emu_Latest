...
PVOID AgpmQuest::MakePacketEmbeddedQuest(INT32 lQuestID, INT32 lParam1, INT32 lParam2, INT32 lItemTID, CHAR* szNPCName, BOOL bRegisterJournal)
{
...
BOOL AgpmQuest::GetFieldEmbeddedPacket(PVOID pvPacket, INT32 &lQuestID, INT32 &lParam1, INT32 &lParam2, INT32 &lItemTID, CHAR*& szNPCName, BOOL &bRegisterJournal)
{
...
PVOID AgpmQuest::MakePacketInitQuest(INT16 *pnPacketLength, INT32 lCID, AgpdCurrentQuest* pCurrentQuest)
{
	PVOID pvEmbeddedPacket = MakePacketEmbeddedQuest(pCurrentQuest->lQuestID, 
												pCurrentQuest->lParam1, pCurrentQuest->lParam2, 0, pCurrentQuest->szNPCName, pCurrentQuest->bRegisterJournal);
...
PVOID AgpmQuest::MakePacketQuestComplete(INT16 *pnPacketLength, ApdEvent *pEvent, INT32 lCID, INT32 lQuestTID, INT32 lSelectItemIndex)
{
	if (!pnPacketLength) return NULL;
...
PVOID AgpmQuest::MakePacketUpdateQuest(INT16 *pnPacketLength, INT32 lCID, INT32 lQuestTID, INT32 lItemTID, AgpdCurrentQuest* pCurrentQuest)
{
	...
	PVOID pvEmbeddedPacket = MakePacketEmbeddedQuest(pCurrentQuest->lQuestID, 
												pCurrentQuest->lParam1, pCurrentQuest->lParam2, lItemTID, pCurrentQuest->szNPCName, pCurrentQuest->bRegisterJournal);
...
PVOID AgpmQuest::MakePacketQuestRegisterJournal(INT16 *pnPacketLength, INT32 lCID, INT32 lQuestTID, BOOL bRegisterJournal)
{
	if (!pnPacketLength) return NULL;

	PVOID pvEmbeddedPacket = MakePacketEmbeddedQuest(lQuestTID,
		0, 0, 0, NULL, bRegisterJournal);

	INT8 cOperation = AGPMQUEST_PACKET_OPERATION_QUEST_REGISTER_JOURNAL_CHANGE;
