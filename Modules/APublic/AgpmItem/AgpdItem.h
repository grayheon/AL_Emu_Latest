...
const INT32 AGPMITEM_CHARGING_TYPE_LAYER				= 1;
const INT32 AGPMITEM_CHARGING_TYPE_ROW					= 8;
const INT32 AGPMITEM_CHARGING_TYPE_COLUMN				= 4;
...
const INT32 AGPMITEM_DEFAULT_INVEN_NUM					= 64;	// 캐릭터가 기본으로 가지고 있는 인벤속 아이템 배열 갯수
...
const INT32 AGPMITEM_REVERSE_ORB_REUSE_INTERVAL			= 1800000;	// 30분, 리버스오브 재사용 쿨타임(ItemDataTable.txt에서 개별설정하여 쓰던것을 옮겨옴)
...
//	Define item status flag
//////////////////////////////////////////////////////////////////
#define	AGPMITEM_BOUND_SHRINE_ITEM						0x00000020
...
//	PVOID		m_pvItemData[AGPMITEM_MAX_ITEM_OWN];	// 아이템 데이타 포인터
	...
	AgpdGrid		m_csChargingInventoryGrid;	// 유료 인벤토리 (가방) // UnSeenInventory
	...
	BOOL					m_bUseChagingInventory;				// 현재 유료인벤토리를 사용중인지 여부

	AgpmItemUsableChargingBagType	m_eChargingBagType;	// Charging Bag Type
