...
enum AgpmItemUsableType
{
	...
	AGPMITEM_USABLE_TYPE_PRIVATE_TRADE_OPTION	,	// 개인거래 보조 아이템(ex, 귀속아이템 거래가능 아이템등)
	AGPMITEM_USABLE_TYPE_CERARIUMORB			= 36,	// 케라리움오브
	AGPMITEM_USABLE_TYPE_JANUS_TALISMAN			= 37,	// 야누스의 부적
	AGPMITEM_USABLE_TYPE_CHARGING_BAG			,		//	유료 가방 (유료 인벤토리)
...
enum AgpmItemUsablePotionType2
{
	...
	AGPMITEM_USABLE_POTION_TYPE2_SHRINE		= 6,	// 쉬라인 물약
};
...
enum AgpmItemOtherType
{
	...
	AGPMITEM_OTHER_TYPE_SHRINE_COIN,		// 쉬라인 코인
...
enum AgpmItemUsableJanusTalismanType
{
	AGPMITEM_USABLE_JANUS_TALISMAN_TYPE_NONE = 0,
	AGPMITEM_USABLE_JANUS_TALISMAN_TYPE_EXP,
	AGPMITEM_USABLE_JANUS_TALISMAN_TYPE_DROP,
	AGPMITEM_USABLE_JANUS_TALISMAN_TYPE_DROP2,
	AGPMITEM_USABLE_JANUS_TALISMAN_TYPE_GHELD,
	AGPMITEM_USABLE_JANUS_TALISMAN_TYPE_MAX,
};

enum AgpmItemUsableChargingBagType
{
	AGPMITEM_USABLE_CHARGING_BAG_TYPE_NONE = -1,
	AGPMITEM_USABLE_CHARGING_BAG_TYPE_A = 1,			// 4 * 4 Type
	AGPMITEM_USABLE_CHARGING_BAG_TYPE_B,				// 4 * 8 Type
	AGPMITEM_USABLE_CHARGING_BAG_TYPE_MAX
};
...
enum AgpdItemStatus
{
	...
	AGPDITEM_STATUS_CHARGING_INVENTORY,		// Charging Inventory
...
//JK_쉬라인상점
enum eAgpmItemShrineTypw
{
	AGPMITEM_SHRINE_TYPE_NONE = 0,
	AGPMITEM_SHRINE_TYPE_SHRINEITEM = 1000,
};

typedef struct _stGachaPoint
{
	INT32		m_nPointEXP;
	INT32		m_nPointGheld;
	INT32		m_nPointCharismaPoint;
	
	INT32		m_nPercentEXP;
	INT32		m_nPercentGheld;
	INT32		m_nPercentCharismaPoint;

	_stGachaPoint()
		: m_nPointEXP(0), m_nPointGheld(0), m_nPointCharismaPoint(0),
		m_nPercentEXP(0), m_nPercentGheld(0), m_nPercentCharismaPoint(0)
	{
	}
...
public:
	...
	vector<INT32>			m_vClassifyID;				// 아이템의 계열, 계열이 같으면 중복 사용할 수 없다
	...
	BOOL					m_bIsGachaPointType;		// 가챠 결과로 EXP, Gheld, CharismaPoint를 주는 아이템들
	stGachaPoint			m_stGachaPoint	;			// m_bIsGachaTypePoint 설정일때 주어야 하는 포인트의 양
...
class AgpdItemTemplateUsableJanusTalisman : public AgpdItemTemplateUsable {
public:
	INT32					m_lSkillTID;
	INT32					m_lSkillLevel;
	AgpmItemUsableJanusTalismanType	m_eJanusTalismanType;
};
