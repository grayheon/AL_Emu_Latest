...
namespace Siegewar_AttackObject_Grid
{
	enum size_e {
		layer		= 1,
		row			= 2,
		colum		= 4,
		max_count	= layer * row * colum,
	};
};
...
public:
	...
	AgpdSiegeWarScore		m_stAttackPvPScore;
	AgpdSiegeWarScore		m_stDefensePvPScore;

	INT8				m_cLastSendRemainTime;
	INT8				m_cLastSendWarinfoStep;
	INT8				m_cLastSendWarinfoMessageStep;
...
public:
	AgpdSiegeWar()
	{
		...
		m_cLastSendWarinfoStep = 0;
		m_cLastSendWarinfoMessageStep = 0;
	...
	void IncreaseAttackPvPScore(){m_stAttackPvPScore.IncreaseWinScore();m_stDefensePvPScore.IncreaseLoseScore();}
	void IncreaseDefensePvPScore(){m_stDefensePvPScore.IncreaseWinScore();m_stAttackPvPScore.IncreaseLoseScore();}
