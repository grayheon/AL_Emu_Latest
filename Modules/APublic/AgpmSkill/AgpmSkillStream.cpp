...
INT16 AgpmSkill::GetConstFactorIndex(const CHAR *szName, INT32 lType)
{
	...
	else if(_stricmp(szName, StringAppend::Append(AGPMSKILL_EXCEL_COLUMN_SPECIAL_STATUS_RATE, szAppend)) == 0)
		return AGPMSKILL_CONST_SPECIAL_STATUS_RATE;
	...
	else if(_stricmp(szName, StringAppend::Append(AGPMSKILL_EXCEL_COLUMN_FACTOR_IGNORE_PHYSICAL_ATTACK_REGIST, szAppend)) == 0)
		return AGPMSKILL_CONST_IGNORE_PHYSICAL_ATTACK_RESIST;
	else if(_stricmp(szName, StringAppend::Append(AGPMSKILL_EXCEL_COLUMN_FACTOR_IGNORE_BLOCK_RATE, szAppend)) == 0)
		return AGPMSKILL_CONST_IGNORE_BLOCK_RATE;
	else if(_stricmp(szName, StringAppend::Append(AGPMSKILL_EXCEL_COLUMN_FACTOR_IGNORE_SKILL_BLOCK_RATE, szAppend)) == 0)
		return AGPMSKILL_CONST_IGNORE_SKILL_BLOCK_RATE;
	else if(_stricmp(szName, StringAppend::Append(AGPMSKILL_EXCEL_COLUMN_FACTOR_IGNORE_EVADE_RATE, szAppend)) == 0)
		return AGPMSKILL_CONST_IGNORE_EVADE_RATE;
	else if(_stricmp(szName, StringAppend::Append(AGPMSKILL_EXCEL_COLUMN_FACTOR_IGNORE_DODGE_RATE, szAppend)) == 0)
		return AGPMSKILL_CONST_IGNORE_DODGE_RATE;
	else if(_stricmp(szName, StringAppend::Append(AGPMSKILL_EXCEL_COLUMN_FACTOR_IGNORE_CRITICAL_DEFENSE_RATE, szAppend)) == 0)
		return AGPMSKILL_CONST_IGNORE_CRITICAL_DEFENSE_RATE;
	else if(_stricmp(szName, StringAppend::Append(AGPMSKILL_EXCEL_COLUMN_FACTOR_IGNORE_STUN_DEFENSE_RATE, szAppend)) == 0)
		return AGPMSKILL_CONST_IGNORE_STUN_DEFENSE_RATE;
...
//			break;
	...
	// Ignore Status Buff
	else if (!strncmp(szTypeName, AGPMSKILL_EXCEL_COLUMN_IGNORE_STATUS_TYPE, strlen(AGPMSKILL_EXCEL_COLUMN_IGNORE_STATUS_TYPE)))
	{
		pcsSkillTemplate->m_lEffectType[nIndex] |= AGPMSKILL_EFFECT_IGNORE_STATUS_TYPE;
		if (bProcessInterval)
			pcsSkillTemplate->m_lProcessIntervalEffectType[nIndex] |= AGPMSKILL_EFFECT_IGNORE_STATUS_TYPE;
	}
	...
	else if (!strncmp(szTypeName, AGPMSKILL_EXCEL_COLUMN_SKILL_FACTOR_ADJUST, strlen(AGPMSKILL_EXCEL_COLUMN_SKILL_FACTOR_ADJUST)))
	{
		...
		case 8:
			pcsSkillTemplate->m_lEffectType[nIndex] |= AGPMSKILL_EFFECT_SKILL_FACTOR_ADJUST_MODIFIED_SKILL_DURATION;
			if(bProcessInterval)
				pcsSkillTemplate->m_lProcessIntervalEffectType[nIndex] |= AGPMSKILL_EFFECT_SKILL_FACTOR_ADJUST_MODIFIED_SKILL_DURATION;
			break;
...
// 		}
	...
	else if(!strcmp(szTypeName, AGPMSKILL_EXCEL_COLUMN_SUMMONS))
	{
		...
		switch(lValue)
		{
			...
			case 11:
				...
				if(bProcessInterval)
					pcsSkillTemplate->m_nProcessIntervalEffectDetailType[AGPMSKILL_EFFECT_DETAIL_SUMMONS] |= AGPMSKILL_EFFECT_DETAIL_SUMMONS_TYPE11;
				break;
		}
	}
	...
	else if(!strcmp(szTypeName, AGPMSKILL_EXCEL_COLUMN_TARGET_RESTRICTION))
	{
		...
		if(lValue & AGPMSKILL_EFFECT_DETAIL_TARGET_RESTRICTION_MONSTER)
		{
			pcsSkillTemplate->m_nEffectDetailType[AGPMSKILL_EFFECT_DETAIL_TARGET_RESTRICTION] |= AGPMSKILL_EFFECT_DETAIL_TARGET_RESTRICTION_MONSTER;
			if(bProcessInterval)
				pcsSkillTemplate->m_nProcessIntervalEffectDetailType[AGPMSKILL_EFFECT_DETAIL_TARGET_RESTRICTION] |= AGPMSKILL_EFFECT_DETAIL_TARGET_RESTRICTION_MONSTER;
		}

		if(lValue & AGPMSKILL_EFFECT_DETAIL_TARGET_RESTRICTION_ENEMY_PC)
		{
			pcsSkillTemplate->m_nEffectDetailType[AGPMSKILL_EFFECT_DETAIL_TARGET_RESTRICTION] |= AGPMSKILL_EFFECT_DETAIL_TARGET_RESTRICTION_ENEMY_PC;
			if(bProcessInterval)
				pcsSkillTemplate->m_nProcessIntervalEffectDetailType[AGPMSKILL_EFFECT_DETAIL_TARGET_RESTRICTION] |= AGPMSKILL_EFFECT_DETAIL_TARGET_RESTRICTION_ENEMY_PC;
		}
	}
...
BOOL AgpmSkill::SetTooptipType(AgpdSkillTooltipTemplate *pcsTooltip, CHAR *szTypeName, CHAR *szValue, BOOL bIsFactorPoint)
{
	...
	else if (!strcmp(szTypeName, AGPMSKILL_TOOLTIP_COLUMN_SKILL_EFFECT_RATE))
		pcsTooltip->m_ullSpecialEffectType		|=	AGPMSKILL_TOOLTIP_SKILL_EFFECT_RATE;
