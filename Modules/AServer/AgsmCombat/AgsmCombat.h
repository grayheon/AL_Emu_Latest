...
public:
	...
	// for Calculrate Damage
	INT32	GetCriticalDefenceRate(AgpdCharacter* pcsAttacker, AgpdCharacter* pcsTarget);
	INT32	GetStunDefenceRate(AgpdCharacter* pcsAttacker, AgpdCharacter* pcsTarget);
};
