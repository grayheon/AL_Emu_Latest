...
typedef enum _eAgsmRelay2Param
	...
	AGSMRELAY_PARAM_PVP,									// PvP

	AGSMRELAY_PARAM_SERVERMOVE,								// 83. 특성화 서버 서버이동 //JK_특성화서버
	AGSMRELAY_PARAM_USE_ESCAPE_UPDATE	= 87,						// 87 탈출 명령어
...
//webzen auth log
class AgsdRelay2Log_WebzenAuth : public AgsdRelay2Log, public ApMemory<AgsdRelay2Log_WebzenAuth, 10000>
{
public:
	AgpdLog_Global		m_csLog;
...
public:
	AgsdRelay2Log_WebzenAuth();
	AgsdRelay2Log_WebzenAuth(AgpdLog* pLog);
	~AgsdRelay2Log_WebzenAuth()	
	{
		Release();
	}
	...
	//void	SetStaticQuery(CHAR *pszDest, CHAR *pszFmt);
};
...
class AgsdRelay2CharacterCoupon : public AgsdDBParam, public ApMemory<AgsdRelay2CharacterCoupon, 10>
{
public:
	INT16	nOperation;
	INT16	nResult;
	...
	INT32	lCouponType;
	CHAR	strCharName[AGSMACCOUNT_MAX_ACCOUNT_NAME + 1];
	CHAR	strCouponNo[AGPPACCOUNT_MAX_COUPONNO + 1];

	AgsdRelay2CharacterCoupon(UINT32 ulNID, INT16 Operation);
	virtual ~AgsdRelay2CharacterCoupon();
...
class AgsdRelay2PvP : public AgsdDBParam, public ApMemory<AgsdRelay2PvP, 10>
{
public:
	INT16	m_nOperation;

	CHAR	m_szCharID[AGPACHARACTER_MAX_ID_STRING + 1];
	INT32	m_lTotalWin;
	INT32	m_lTotalLose;
	INT32	m_lVSHumanWin;
...
public:
	...
	AgsdRelay2PvP(UINT32 ulNID, INT16 Operation);
	virtual ~AgsdRelay2PvP() {}
...
class AgsdRelay2PvPLoad : public AgsdDBParam, public ApMemory<AgsdRelay2PvPLoad, 10>
{
public:
	INT16	m_nOperation;
	...
	AgsdRelay2PvPLoad(UINT32 ulNID, INT16 Operation);
	virtual ~AgsdRelay2PvPLoad() {}
...
class AgsdRelay2Escape : public AgsdDBParam, public ApMemory<AgsdRelay2Escape, 10>
{
public :
	INT16	m_nOperation;
	CHAR	m_szCharID[_MAX_CHARNAME_LENGTH + 1];
	CHAR	m_szUseEscapeDate[AGPMGUILD_MAX_DATE_LENGTH + 1];
	UINT32	m_lUseEscapeDate;

protected:
	BOOL	SetParamUpdate(AuStatement *pStatement);

public:
	AgsdRelay2Escape(UINT32 ulNID, INT16 Operation);
	virtual ~AgsdRelay2Escape()	{}
	virtual void Release()	{ delete this; }
};
