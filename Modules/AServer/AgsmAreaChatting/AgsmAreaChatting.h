...
typedef enum	_AgsmAreaChatType	{
	AGSMAREACHAT_TYPE_REGION				= 1,			// 외치기
	AGSMAREACHAT_TYPE_RACE,									// 종족 나팔
	AGSMAREACHAT_TYPE_ALL,									// 정령의 외침(세계 외침)
	AGSMAREACHAT_TYPE_GLOBAL,
	AGSMAREACHAT_TYPE_ARCHLORD,								// 아크로드
} AgsmAreaChatType;
...
public:
	...
	ApAdmin* GetAllAdmin()	{return &m_csAllPlayerAdmin;}//JK_쉬라인머지
};
