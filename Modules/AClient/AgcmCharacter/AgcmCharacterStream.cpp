...
#define AGCMCHAR_INI_NAME_DNF_5						"DID_NOT_FINISH_TAIWAN"
//@}
...
//@}
{
	...
	pcsStream->WriteValue(AGCMCHAR_INI_NAME_DNF_5, (pstAgcdCharacterTemplate->m_nDNF & GETSERVICEAREAFLAG(AP_SERVICE_AREA_TAIWAN	)) ? 1 : 0);
	//@}	
