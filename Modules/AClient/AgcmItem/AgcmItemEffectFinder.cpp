...
void AgcmItemEffectFinder::LoadCloakEffectID( void )
{
	...
	//다크니스
	AddCloakEffectID( Cloak_Darkness, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_DARKNESS_CLOAK_HK );
	AddCloakEffectID( Cloak_Darkness, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_DARKNESS_CLOAK_HA );
	AddCloakEffectID( Cloak_Darkness, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_DARKNESS_CLOAK_HM );

	AddCloakEffectID( Cloak_Darkness, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_DARKNESS_CLOAK_OB );
	AddCloakEffectID( Cloak_Darkness, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_DARKNESS_CLOAK_OH );
	AddCloakEffectID( Cloak_Darkness, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_DARKNESS_CLOAK_OS );

	AddCloakEffectID( Cloak_Darkness, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_DARKNESS_CLOAK_MS );
	AddCloakEffectID( Cloak_Darkness, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_DARKNESS_CLOAK_MR );
	AddCloakEffectID( Cloak_Darkness, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_DARKNESS_CLOAK_ME );

	//블러드
	AddCloakEffectID( Clock_Blood, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_BLOOD_CLOAK_HK );
	AddCloakEffectID( Clock_Blood, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_BLOOD_CLOAK_HA );
	AddCloakEffectID( Clock_Blood, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_BLOOD_CLOAK_HM );

	AddCloakEffectID( Clock_Blood, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_BLOOD_CLOAK_OB );
	AddCloakEffectID( Clock_Blood, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_BLOOD_CLOAK_OH );
	AddCloakEffectID( Clock_Blood, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_BLOOD_CLOAK_OS );

	AddCloakEffectID( Clock_Blood, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_BLOOD_CLOAK_MS );
	AddCloakEffectID( Clock_Blood, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_BLOOD_CLOAK_MR );
	AddCloakEffectID( Clock_Blood, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_BLOOD_CLOAK_ME );

	//로얄
	AddCloakEffectID( Clock_Royal, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_ROYAL_CLOAK_HK );
	AddCloakEffectID( Clock_Royal, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_ROYAL_CLOAK_HA );
	AddCloakEffectID( Clock_Royal, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_ROYAL_CLOAK_HM );

	AddCloakEffectID( Clock_Royal, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_ROYAL_CLOAK_OB );
	AddCloakEffectID( Clock_Royal, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_ROYAL_CLOAK_OH );
	AddCloakEffectID( Clock_Royal, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_ROYAL_CLOAK_OS );

	AddCloakEffectID( Clock_Royal, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_ROYAL_CLOAK_MS );
	AddCloakEffectID( Clock_Royal, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_ROYAL_CLOAK_MR );
	AddCloakEffectID( Clock_Royal, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_ROYAL_CLOAK_ME );

	AddCloakEffectID( Clock_Royal, 	AURACE_TYPE_DRAGONSCION, 		AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_ROYAL_CLOAK_SLA );
	AddCloakEffectID( Clock_Royal, 	AURACE_TYPE_DRAGONSCION, 		AUCHARCLASS_TYPE_SCION,		E_COMMON_CHAR_TYPE_ROYAL_CLOAK_SCI );
	AddCloakEffectID( Clock_Royal, 	AURACE_TYPE_DRAGONSCION, 		AUCHARCLASS_TYPE_RANGER,		E_COMMON_CHAR_TYPE_ROYAL_CLOAK_OBI );


	//INFLAME
	AddCloakEffectID( Clock_Inflame, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_INFLAME_CLOAK_HK );
	AddCloakEffectID( Clock_Inflame, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_INFLAME_CLOAK_HA );
	AddCloakEffectID( Clock_Inflame, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_INFLAME_CLOAK_HM );

	AddCloakEffectID( Clock_Inflame, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_INFLAME_CLOAK_OB );
	AddCloakEffectID( Clock_Inflame, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_INFLAME_CLOAK_OH );
	AddCloakEffectID( Clock_Inflame, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_INFLAME_CLOAK_OS );

	AddCloakEffectID( Clock_Inflame, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_INFLAME_CLOAK_MS );
	AddCloakEffectID( Clock_Inflame, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_INFLAME_CLOAK_MR );
	AddCloakEffectID( Clock_Inflame, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_INFLAME_CLOAK_ME );


	//ARTHIAN
	AddCloakEffectID( Clock_Arthian, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_ARTHIAN_CLOAK_HK );
	AddCloakEffectID( Clock_Arthian, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_ARTHIAN_CLOAK_HA );
	AddCloakEffectID( Clock_Arthian, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_ARTHIAN_CLOAK_HM );

	AddCloakEffectID( Clock_Arthian, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_ARTHIAN_CLOAK_OB );
	AddCloakEffectID( Clock_Arthian, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_ARTHIAN_CLOAK_OH );
	AddCloakEffectID( Clock_Arthian, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_ARTHIAN_CLOAK_OS );

	AddCloakEffectID( Clock_Arthian, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_ARTHIAN_CLOAK_MS );
	AddCloakEffectID( Clock_Arthian, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_ARTHIAN_CLOAK_MR );
	AddCloakEffectID( Clock_Arthian, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_ARTHIAN_CLOAK_ME );

	//Traqua
	AddCloakEffectID( Clock_Traqua, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_TRAQUA_CLOAK_HK );
	AddCloakEffectID( Clock_Traqua, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_TRAQUA_CLOAK_HA );
	AddCloakEffectID( Clock_Traqua, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_TRAQUA_CLOAK_HM );

	AddCloakEffectID( Clock_Traqua, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_TRAQUA_CLOAK_OB );
	AddCloakEffectID( Clock_Traqua, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_TRAQUA_CLOAK_OH );
	AddCloakEffectID( Clock_Traqua, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_TRAQUA_CLOAK_OS );

	AddCloakEffectID( Clock_Traqua, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_TRAQUA_CLOAK_MS );
	AddCloakEffectID( Clock_Traqua, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_TRAQUA_CLOAK_MR );
	AddCloakEffectID( Clock_Traqua, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_TRAQUA_CLOAK_ME );

	//DRAYGER

	AddCloakEffectID( Clock_Drayger, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_DRAYGER_CLOAK_HK );
	AddCloakEffectID( Clock_Drayger, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_DRAYGER_CLOAK_HA );
	AddCloakEffectID( Clock_Drayger, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_DRAYGER_CLOAK_HM );

	AddCloakEffectID( Clock_Drayger, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_DRAYGER_CLOAK_OB );
	AddCloakEffectID( Clock_Drayger, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_DRAYGER_CLOAK_OH );
	AddCloakEffectID( Clock_Drayger, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_DRAYGER_CLOAK_OS );

	AddCloakEffectID( Clock_Drayger, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_DRAYGER_CLOAK_MS );
	AddCloakEffectID( Clock_Drayger, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_DRAYGER_CLOAK_MR );
	AddCloakEffectID( Clock_Drayger, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_DRAYGER_CLOAK_ME );

	//RENSPHERE

	AddCloakEffectID( Clock_Rensphere, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_RENSPHERE_CLOAK_HK );
	AddCloakEffectID( Clock_Rensphere, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_RENSPHERE_CLOAK_HA );
	AddCloakEffectID( Clock_Rensphere, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_RENSPHERE_CLOAK_HM );

	AddCloakEffectID( Clock_Rensphere, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_RENSPHERE_CLOAK_OB );
	AddCloakEffectID( Clock_Rensphere, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_RENSPHERE_CLOAK_OH );
	AddCloakEffectID( Clock_Rensphere, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_RENSPHERE_CLOAK_OS );

	AddCloakEffectID( Clock_Rensphere, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_RENSPHERE_CLOAK_MS );
	AddCloakEffectID( Clock_Rensphere, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_RENSPHERE_CLOAK_MR );
	AddCloakEffectID( Clock_Rensphere, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_RENSPHERE_CLOAK_ME );

	//ROYAL2

	AddCloakEffectID( Clock_Rayal2, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_ROYAL2_CLOAK_HK );
	AddCloakEffectID( Clock_Rayal2, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_ROYAL2_CLOAK_HA );
	AddCloakEffectID( Clock_Rayal2, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_ROYAL2_CLOAK_HM );

	AddCloakEffectID( Clock_Rayal2, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_ROYAL2_CLOAK_OB );
	AddCloakEffectID( Clock_Rayal2, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_ROYAL2_CLOAK_OH );
	AddCloakEffectID( Clock_Rayal2, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_ROYAL2_CLOAK_OS );

	AddCloakEffectID( Clock_Rayal2, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_ROYAL2_CLOAK_MS );
	AddCloakEffectID( Clock_Rayal2, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_ROYAL2_CLOAK_MR );
	AddCloakEffectID( Clock_Rayal2, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_ROYAL2_CLOAK_ME );

	AddCloakEffectID( Clock_Rayal2, 	AURACE_TYPE_DRAGONSCION, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_ROYAL2_CLOAK_SLA );
	AddCloakEffectID( Clock_Rayal2, 	AURACE_TYPE_DRAGONSCION, 			AUCHARCLASS_TYPE_SCION,	E_COMMON_CHAR_TYPE_ROYAL2_CLOAK_SCI );
	AddCloakEffectID( Clock_Rayal2, 	AURACE_TYPE_DRAGONSCION, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_ROYAL2_CLOAK_OBI );


	//ROYAL3

	AddCloakEffectID( Clock_Rayal3, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_ROYAL3_CLOAK_HK );
	AddCloakEffectID( Clock_Rayal3, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_ROYAL3_CLOAK_HA );
	AddCloakEffectID( Clock_Rayal3, 	AURACE_TYPE_HUMAN, 			AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_ROYAL3_CLOAK_HM );

	AddCloakEffectID( Clock_Rayal3, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_ROYAL3_CLOAK_OB );
	AddCloakEffectID( Clock_Rayal3, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_ROYAL3_CLOAK_OH );
	AddCloakEffectID( Clock_Rayal3, 	AURACE_TYPE_ORC, 			AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_ROYAL3_CLOAK_OS );

	AddCloakEffectID( Clock_Rayal3, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_ROYAL3_CLOAK_MS );
	AddCloakEffectID( Clock_Rayal3, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_ROYAL3_CLOAK_MR );
	AddCloakEffectID( Clock_Rayal3, 	AURACE_TYPE_MOONELF, 		AUCHARCLASS_TYPE_MAGE,		E_COMMON_CHAR_TYPE_ROYAL3_CLOAK_ME );

	AddCloakEffectID( Clock_Rayal3, 	AURACE_TYPE_DRAGONSCION, 			AUCHARCLASS_TYPE_KNIGHT,	E_COMMON_CHAR_TYPE_ROYAL3_CLOAK_SLA );
	AddCloakEffectID( Clock_Rayal3, 	AURACE_TYPE_DRAGONSCION, 			AUCHARCLASS_TYPE_SCION,	E_COMMON_CHAR_TYPE_ROYAL3_CLOAK_SCI );
	AddCloakEffectID( Clock_Rayal3, 	AURACE_TYPE_DRAGONSCION, 			AUCHARCLASS_TYPE_RANGER,	E_COMMON_CHAR_TYPE_ROYAL3_CLOAK_OBI );
