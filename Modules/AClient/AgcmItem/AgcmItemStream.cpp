		...
		if(!strcmp(pcsStream->GetValueName(), AGCMITEM_INI_NAME_BASE_CLUMP))
		{
			...
			if (strcmp(value_buffer, ""))
			{
				if (pstAgcdItemTemplate->m_pcsPreData)
				{
					...
					#ifdef _BIN_EXEC_
					ItemClumpInfo::Get( pcsAgpdItemTemplate->GetID() ).baseDff( value_buffer );
					#endif
				}
				else
				{
		...
		else if(!strcmp(pcsStream->GetValueName(), AGCMITEM_INI_NAME_SECOND_CLUMP))
		{
			...
			if (strcmp(value_buffer, ""))
			{
				if (pstAgcdItemTemplate->m_pcsPreData)
				{
					...
					#ifdef _BIN_EXEC_
					ItemClumpInfo::Get( pcsAgpdItemTemplate->GetID() ).secondDff( value_buffer );
					#endif
				}
				else
				{
		...
		else if(!strcmp(pcsStream->GetValueName(), AGCMITEM_INI_NAME_FIELD_CLUMP))
		{
			...
			if (strcmp(value_buffer, ""))
			{
				if (pstAgcdItemTemplate->m_pcsPreData)
				{
					...
					#ifdef _BIN_EXEC_
					ItemClumpInfo::Get( pcsAgpdItemTemplate->GetID() ).fieldDff( value_buffer );
					#endif
				}
				else
				{
		...
		else if(!strcmp(pcsStream->GetValueName(), AGCMITEM_INI_NAME_PICK_CLUMP))
		{
			...
			if (strcmp(value_buffer, ""))
			{
				if (pstAgcdItemTemplate->m_pcsPreData)
				{
					...
					#ifdef _BIN_EXEC_
					ItemClumpInfo::Get( pcsAgpdItemTemplate->GetID() ).pickDff( value_buffer );
					#endif
				}
				else
				{
		...
		else if(!strcmp(pcsStream->GetValueName(), AGCMITEM_INI_NAME_TEXTURE))
		{
			...
			if (strcmp(value_buffer, ""))
			{
				if (pstAgcdItemTemplate->m_pcsPreData)
				{
					...
					#ifdef _BIN_EXEC_
					ItemClumpInfo::Get( pcsAgpdItemTemplate->GetID() ).textureName( value_buffer );
					#endif
				}
				else
				{
					#ifdef _BIN_EXEC_
					ItemClumpInfo::Get( pcsAgpdItemTemplate->GetID() ).textureName( value_buffer );
					pstAgcdItemTemplate->SetFileNameTexture(value_buffer);
#else
					ulTemp1	= atoi(value_buffer);
		...
		else if(!strcmp(pcsStream->GetValueName(), AGCMITEM_INI_NAME_SMALL_TEXTURE))
		{
			...
			if (strcmp(value_buffer, ""))
			{
				if (pstAgcdItemTemplate->m_pcsPreData)
				{
					...
					#ifdef _BIN_EXEC_
					ItemClumpInfo::Get( pcsAgpdItemTemplate->GetID() ).smallTextureName( value_buffer );
					#endif
				}
				else
				{
		...
		else if(!strcmp(pcsStream->GetValueName(), AGCMITEM_INI_NAME_DURABILITY_ZERO_TEXTURE))
		{
			...
			if (strcmp(value_buffer, ""))
			{
				if (pstAgcdItemTemplate->m_pcsPreData)
				{
					...
					#ifdef _BIN_EXEC_ 
					ItemClumpInfo::Get( pcsAgpdItemTemplate->GetID() ).durZeroTextureName( value_buffer );
					#endif
				}
				else
				{
		...
		else if(!strcmp(pcsStream->GetValueName(), AGCMITEM_INI_NAME_DURABILITY_5UNDER_TEXTURE))
		{
			...
			if (strcmp(value_buffer, ""))
			{
				if (pstAgcdItemTemplate->m_pcsPreData)
				{
					...
					#ifdef _BIN_EXEC_
					ItemClumpInfo::Get( pcsAgpdItemTemplate->GetID() ).dur5UnderTextureName( value_buffer );
					#endif
				}
				else
				{
...
#ifdef _AREA_GLOBAL_
	pcsStream->WriteValue(AGCMITEM_INI_NAME_DNF_3, (pstAgcdItemTemplate->m_nDNF & GETSERVICEAREAFLAG(AP_SERVICE_AREA_GLOBAL		)) ? 1 : 0);
#endif

	pcsStream->WriteValue(AGCMITEM_INI_NAME_DNF_4, (pstAgcdItemTemplate->m_nDNF & GETSERVICEAREAFLAG(AP_SERVICE_AREA_JAPAN		)) ? 1 : 0);
	pcsStream->WriteValue(AGCMITEM_INI_NAME_DNF_5, (pstAgcdItemTemplate->m_nDNF & GETSERVICEAREAFLAG(AP_SERVICE_AREA_TAIWAN		)) ? 1 : 0);
	//@}
