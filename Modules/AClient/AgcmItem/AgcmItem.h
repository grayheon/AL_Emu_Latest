...
#define AGCMITEM_INI_NAME_DNF_5						"DID_NOT_FINISH_TAIWAN"
...
public:
	...
	BOOL					UseChargingInventory(AgpdItem *pcsItem);
	...
	BOOL					SetCallbackUseChargingInventory	(ApModuleDefaultCallBack pfCallback, PVOID pClass);
	...
	BOOL					SendChargingInventoryInfo(INT32 lIID, INT32 lCID, INT16 nInvIdx = -1, INT16 nInvRow = -1, INT16 nInvCol = -1);
	...
	BOOL					SendTooltipRegisterItemRequest(  INT32 llID , INT lTID , INT32 lCID, eAgpmItemTooltipType type );
