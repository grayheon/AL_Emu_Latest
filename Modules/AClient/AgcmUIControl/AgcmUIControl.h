...
#define AGCMUICONTROL_KEY_NAME_WAIT_BACK						"wait_back"
#define AGCMUICONTROL_KEY_NAME_EDIT_CONTROL_IMAGE				"edit_control_image"
...
#define AGCMUICONTROL_KEY_NAME_PVP_SAFE							"pvp_safe"
#define AGCMUICONTROL_KEY_NAME_PVP_WAR							"pvp_war"
#define AGCMUICONTROL_KEY_NAME_STATE_BATTLE						"state_battle"
#define AGCMUICONTROL_KEY_NAME_STATE_BATTLE_END					"state_battle_end"
#define AGCMUICONTROL_KEY_NAME_STATE_BE_WANTED					"WantedAlarm"
...
#ifdef _AREA_GLOBAL_
#define AGCMUICONTROL_KEY_NAME_PC_ROOM							"PCRoom"
#endif
...
#define UICM_CUSTORM_MAX_MESSAGE								35
// ----------------- CUIOpenCloseSystem ------------------
...
#ifdef _AREA_GLOBAL_
	VOID						SetButtonName					( CHAR *szOK, CHAR *szCancel ,CHAR* szThree = NULL);
#else
...
public:
	...
	RwTexture*													m_pPvPSafe;
	RwTexture*													m_pPvPWar;

	RwTexture*													m_pStateBattle;
	RwTexture*													m_pStateBattleEnd;
	
	RwTexture*													m_pStateBeWanted;
...
#ifdef _AREA_GLOBAL_
	AcUIThreeBtnDialog											m_clThreeBtnDialog;
#endif
	AcUIEditOKDialog											m_clEditOKDialog;
	AcUIEditOKCancelDialog										m_clEditOKCancelDialog;
