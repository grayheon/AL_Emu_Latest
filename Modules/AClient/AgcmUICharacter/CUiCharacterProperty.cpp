...
{
	m_eCurrentPropertyType = ePropertyType_Attack;
...
BOOL CUiCharacterProperty::OnInitializeProperty( void )
{
	...
	if( !_LoadPropertyView( "INI\\CharacterPropertyView.xml", decrypt ) ) return FALSE;
	return TRUE;
}
...
BOOL CUiCharacterProperty::_InitPropertyCallBack( void )
{
	...
	RegisterPropertyCallBack( "fn_CharacterProperty_IgnoreTargetPhysicalRes",	fn_CharacterProperty_IgnoreTargetPhysicalRes );
	RegisterPropertyCallBack( "fn_CharacterProperty_IgnoreTargetBlock",			fn_CharacterProperty_IgnoreTargetBlock );
	RegisterPropertyCallBack( "fn_CharacterProperty_IgnoreTargetSkillBlock",	fn_CharacterProperty_IgnoreTargetSkillBlock );
	RegisterPropertyCallBack( "fn_CharacterProperty_IgnoreTargetMeleeDodge",	fn_CharacterProperty_IgnoreTargetMeleeDodge );
	RegisterPropertyCallBack( "fn_CharacterProperty_IgnoreTargetRangeDodge",	fn_CharacterProperty_IgnoreTargetRangeDodge );
	RegisterPropertyCallBack( "fn_CharacterProperty_IgnoreTargetCriticalRes",	fn_CharacterProperty_IgnoreTargetCriticalRes );
	RegisterPropertyCallBack( "fn_CharacterProperty_IgnoreTargetStunRes",		fn_CharacterProperty_IgnoreTargetStunRes );
	...
	RegisterPropertyCallBack( "fn_CharacterProperty_PVPTotalWin",				fn_CharacterProperty_PVPTotalWin );
	RegisterPropertyCallBack( "fn_CharacterProperty_PVPTotalLose",				fn_CharacterProperty_PVPTotalLose );

	//	향후 쉬라인 오픈시 종족별 전적이 추가됩니다. 요건 미리 작업해둔것
// 	RegisterPropertyCallBack( "fn_CharacterProperty_PVPHumanWin",				fn_CharacterProperty_PVPHumanWin );
// 	RegisterPropertyCallBack( "fn_CharacterProperty_PVPHumanLose",				fn_CharacterProperty_PVPHumanLose );
// 	RegisterPropertyCallBack( "fn_CharacterProperty_PVPOrcWin",					fn_CharacterProperty_PVPOrcWin );
// 	RegisterPropertyCallBack( "fn_CharacterProperty_PVPOrcLose",				fn_CharacterProperty_PVPOrcLose );
// 	RegisterPropertyCallBack( "fn_CharacterProperty_PVPMoonElfWin",				fn_CharacterProperty_PVPMoonElfWin );
// 	RegisterPropertyCallBack( "fn_CharacterProperty_PVPMoonElfLose",			fn_CharacterProperty_PVPMoonElfLose );
// 	RegisterPropertyCallBack( "fn_CharacterProperty_PVPScionWin",				fn_CharacterProperty_PVPScionWin );
// 	RegisterPropertyCallBack( "fn_CharacterProperty_PVPScionLose",				fn_CharacterProperty_PVPScionLose );
