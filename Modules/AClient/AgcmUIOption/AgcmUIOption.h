...
enum AgcmUIOptionCB{
	AGCMUIOPTION_CB_ID_USE_NEW_SLOT	= 0,
};
...
// #endif
	...
	AgcdUIUserData*		m_pstUDUseNewSlot;
...
// #endif
	...
	void	UpdateUseNewSlot(BOOL	bRefresh);
...
// #endif
	...
	static BOOL		CBUseNewSlot(PVOID pClass, PVOID pData1, PVOID pData2, PVOID pData3, PVOID pData4, PVOID pData5, ApBase *pcsTarget, AgcdUIControl *pcsSourceControl);
...
public:
	BOOL SetCallbackChangeOptionUseNewSlot(ApModuleDefaultCallBack pfCallback, PVOID pClass);
