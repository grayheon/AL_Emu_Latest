...
#define	AGCMUI_PARTYOPTION_DIVISION_ITEM_DAMAGE				0		// ±‚ø©µµ »πµÊ
#define	AGCMUI_PARTYOPTION_DIVISION_ITEM_SEQUENCE			1		// º¯¬˜¿˚ »πµÊ
#define	AGCMUI_PARTYOPTION_DIVISION_ITEM_FREE				2		// ¿⁄¿Ø»πµÊ

#define	AGCMUI_PARTYOPTION_DIVISION_EXP_DAMAGE				0		// ±‚ø©µµ »πµÊ
#define	AGCMUI_PARTYOPTION_DIVISION_EXP_LEVEL				1		// ∑π∫ß  »πµÊ
...
//	Finish 2005.04.13 by SungHoon
#define UI_MESSAGE_PARTYOPTION_DIVISION_ITEM_SEQUENCE		"º¯¬˜¿˚»πµÊ"
#define UI_MESSAGE_PARTYOPTION_DIVISION_ITEM_FREE			"¿⁄¿Ø»πµÊ"
#define UI_MESSAGE_PARTYOPTION_DIVISION_ITEM_DAMAGE			"±‚ø©µµ»πµÊ"

#define UI_MESSAGE_PARTYOPTION_DIVISION_EXP_DAMAGE			"±‚ø©µµ∫–πË"
#define UI_MESSAGE_PARTYOPTION_DIVISION_EXP_LEVEL			"∑π∫ß±’µÓ∫–¥Î"
...
public:
	...
	void				OpenPartyOption(char* pszInviteName = NULL ){strcpy( m_szDefaultID, pszInviteName); m_pcsAgcmUIManager2->ThrowEvent(m_lEventPartyOptionUIOpenClick);}

//	Begin 2005.04.13 by SungHoon
//	Party Option CallBack Funtion	»Æ¿Œ πˆ∆∞¿ª ¥≠∑∂¿ª∂ß « ø‰¡§∫∏øÕ «‘≤≤ »£√‚µ»¥Ÿ.
