...
public:
	...
	void	DrawTextIM2DScale(float x,float y,float size,char* str,UINT32 fonttype,UINT8 alpha = 255,DWORD color = 0xffffffff,bool bDrawShadow = true, INT32 length = -1, BOOL bClipping = FALSE);
