...
private:
	...
	AgsmShrineBattle		*m_pAgsmShrineBattle;

	AgsmServerManager		*m_pcsAgsmServerManager;
...
public:
	...
	BOOL ProcessMurdererPenalty(AgpdCharacter *pcsAttacker, AgpdCharacter *pcsTarget);
	...
	BOOL IsEnableUpdateOfRacePvPResult(AgpdCharacter* pcsAttacker, AgpdCharacter* pcsTarget);
	...
	BOOL SendPvPResultToDB(AgpdCharacter *pcsCharacter);
