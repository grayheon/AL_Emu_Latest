...
public :
	...
	// 	int					FindEffectIDCloak				( std::string szType, int nRaceType, int nClassType, int nEffectTypeID );
	// 	int					FindEffectIDWing				( std::string szType, int nRaceType, int nClassType, int nEffectTypeID );
