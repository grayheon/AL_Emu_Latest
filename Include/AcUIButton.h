...
public:	
	...
	INT32										m_nButtonSelectTextureID;	// 버튼 클릭시 선택상태 표시 이미지;
...
protected:
	void			_DrawSelectImage			( void );
	VOID			_DrawBgColor				( VOID );
