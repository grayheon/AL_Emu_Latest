...
class AgsmLoginClient : public AgsModule
	...
	public:
		...
		BOOL	ProcessCreateJumpingCharacterCheck(CHAR *pszAccountID, CHAR *pszServerName, CHAR *pszDBName, UINT32 ulNID);
		//	rename
		...
		BOOL	SetBaseCharacterInfo(INT32 lRace, INT32 lClass, INT32 lTID, CHAR* szCharName);
		INT32	GetBaseCharacterTID(INT32 lRace, INT32 lClass);
	};
