...
typedef map<CHAR*, INT32>					FLAG_IMOTICON_MAP;
typedef FLAG_IMOTICON_MAP::iterator			FLAG_IMOTICON_MAP_ITERATOR;

const INT32 MAX_FLAG_LENGTH				=	64;
...
private:
	...
	FLAG_IMOTICON_MAP	m_mapFlagEmoticon;
...
public:
	...
	// Read Stream
	BOOL			ReadFlagImoticon(CHAR* szFileName);
