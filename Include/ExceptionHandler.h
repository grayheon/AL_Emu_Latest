...
// 2006.06.06. steeple
// ApServerMonitor.h 에 있는 ASSM_SERVER_TYPE_XXX 를 따라간다.
// ASSM_SERVER_TYPE_INVALID 이면 Client 임.
extern int		g_iServerClientType;		// ASSM_SERVER
...
bool	StreamReadDumpConfig(char* pszFileName);
//@} Jaewon
