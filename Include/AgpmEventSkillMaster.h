...
typedef std::set<INT32>							ArchlordSkillList;
typedef std::set<INT32>::iterator				ArchlordSkillIter;
typedef std::set<INT32>							RaceSkillList;
typedef std::set<INT32>::iterator				RaceSkillIter;
