...
#define		TB_ID_MAX_CHAR				AGPMITEM_MAX_ITEM_NAME + 1
#define		TB_ID_INTERVAL				14
#define		TB_TEXT_MAX_CHAR			AGPMITEM_MAX_ITEM_NAME + 1
...
enum TEXTBOARD_OFFSET_INDEX
{
	TB_OFFSET_LINE_FIRST			= 0	,
	TB_OFFSET_LINE_SECOND				,
	TB_OFFSET_LINE_THIRD				,
	TB_OFFSET_LINE_FOURTH				,

	TB_OFFSET_LINE_MAX					,
};

enum eShrineNameColor
{
	SHRINE_HUMAN_NAME_COLOR		,
	SHRINE_MOONELF_NAME_COLOR		,
	SHRINE_ORC_NAME_COLOR			,
	SHRINE_DRAGONSCION_NAME_COLOR	,
