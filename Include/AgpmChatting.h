...
typedef enum
{
	...
	AGPDCHATTING_TYPE_ARCHLORD,			// 아크로드
	AGPDCHATTING_TYPE_REGION,			// 외치기
	AGPDCHATTING_TYPE_RACE,				// 종족 나팔
	AGPDCHATTING_TYPE_ALL,				// 정령의 외침(세계 외침)
...
typedef struct	AgpdChatData {
	...
	UINT32				ulCharType;				// Character Type
...
private:
	...
	BOOL			OnOperationChat(AgpdCharacter *pcsCharacter, INT8 cChatType, CHAR *szSenderName, CHAR *szTargetID, UINT32 ulCharType, CHAR *szMessage, UINT16 unMessageLength);
