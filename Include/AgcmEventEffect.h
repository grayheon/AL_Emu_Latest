...
protected:
	...
	std::set<eAgcmEventEffectDataCommonCharType>	m_listCommonEffectData;
...
protected:
	...
	// 변신시 이펙트 복구
	BOOL	SaveCurrentEffectEvolution(eAgcmEventEffectDataCommonCharType eEffect);
	BOOL	RemoveCurrentEffectEvolution(eAgcmEventEffectDataCommonCharType eEffect);
...
protected:
	...
	static BOOL		CBRestoreCommonEffectsByEvolution(PVOID pData, PVOID pClass, PVOID pCustData);
};
