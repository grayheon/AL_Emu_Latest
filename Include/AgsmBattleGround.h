...
private:
	...
	INT32				m_lSendRacePvPInfoMinTime;
	...
	CSpawnVector m_pStepCheckVector;
	...
	// ~어빌리티 몬스터 통제 시스템
	void CheckStepMonster(AgpdCharacter* pcsTarget);
...
public:
	...
	//BOOL ProcessCharismaPoint( AgpdCharacter* pcsCharacter, AgpdCharacter* pcsTarget ); AgsmPVP 로 해당 내용 옮겨짐. 20101207@supertj
	...
	BOOL OnPvPDead(AgpdCharacter* pcsAttackCharacter, AgpdCharacter* pcsDeadCharacter);
...
private:
	...
	static int SendBattleGroundWarInfo(lua_State* L);

	static int SendBattleGroundTimeStep(lua_State* L);
