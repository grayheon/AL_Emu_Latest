...
//여기부터 UI MSG callback
	...
	NPCTRADE_CB_MSG_NOT_ENOUGH_CHARISMA,
	NPCTRADE_CB_MSG_NOT_ENOUGH_SHRINECOIN,
};
...
public:
	...
	BOOL SetCallbackNotEnoughCharisma( ApModuleDefaultCallBack pfCallback , PVOID pClass );
	BOOL SetCallbackNotEnoughShrineCoin( ApModuleDefaultCallBack pfCallback , PVOID pClass );
