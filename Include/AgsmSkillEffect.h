...
public:
	...
	BOOL ProcessSkillEffectIgnoreStatus(AgpdSkill *pcsSkill, ApBase *pcsTarget, INT16 nIndex, BOOL bProcessInterval);
	...
	BOOL ProcessSkillEffect2SummonsType11(AgpdSkill* pcsSkill, ApBase* pcsTarget, BOOL bProcessInterval);
