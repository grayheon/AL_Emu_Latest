...
typedef enum _eAgpmPvPSystemMessageCode
{
	...
	AGPMPVP_SYSTEM_CODE_MURDER_PENALTY_CHARISMA_POINT,				// 카리스마 포인트 감소
...
private:
	...
	AgpmShrineBattle* m_pagpmShrineBattle; //JK_쉬라인머지 
...
public:
	...
	// PvPResult
	BOOL AddRaceWinResult(AgpdCharacter* pcsCharacter, AuRaceType eType);
	BOOL AddRaceLoseResult(AgpdCharacter* pcsCharacter, AuRaceType eType);
	BOOL SetRaceWinResult(AgpdCharacter* pcsCharacter, AuRaceType eType, LONG lPoint);
	BOOL SetRaceLoseResult(AgpdCharacter* pcsCharacter, AuRaceType eType, LONG lPoint);

	// OnReceive
	BOOL OnReceive(UINT32 ulType, PVOID pvPacket, INT16 nSize, UINT32 ulNID, DispatchArg *pstCheckArg);
	BOOL OnReceivePvPInfo(INT32 lCID, INT32 lTargetCID, INT32 lWin, INT32 lLose, INT8 cPvPMode, INT8 cPvPStatus, INT8 cWin, PVOID pcsRacePvPResult);
	...
	PVOID MakePvPPacket(INT16* pnPacketLength, INT8 cOperation, INT32* plCID, INT32* plTargetCID, INT32* plWin, INT32* plLose,
		INT8* pcPvPMode, INT8* pcPvPStatus, INT8* pcWin, CHAR* szGuildID, CHAR* szMessage, AgpdPvPADChar::AgpdRacePvPResult *pcsPvPResult, INT32 *plLength);
	PVOID MakePvPInfoPacket(INT16* pnPacketLength, INT32* plCID, INT32* plWin, INT32* plLose, INT8* pcPvPMode, INT8* pcPvPStatus, AgpdPvPADChar::AgpdRacePvPResult *pcsPvPResult, INT32 *plLength);
