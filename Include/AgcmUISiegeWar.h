...
#define UI_MESSAGE_ID_SIEGEWAR_MESSAGE_ARCHLORDBATTLE_START_TIME "ArchlordBattleMsgStartTime"

#define UI_MESSAGE_ID_SIEGEWAR_MESSAGE_SET_CASTLE_OWNER			"SiegeWarSetCastleOwner"


#define AGCMUISIEGEWAR_PRINT_MESSAGE_TIME 2000
...
private:
	...
	INT32			m_lEventStartSiegeWar;
	INT32			m_lEventCloseSiegeWar;
...
private :
	...
	std::list<std::string> m_listMessageChat;
