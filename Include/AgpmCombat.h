...
public:
	...
	FLOAT				GetPhysicalResistance(AgpdCharacter* pcsCharacter);								// UI 출력용
	FLOAT				GetPhysicalResistance(AgpdCharacter* pcsAttacker, AgpdCharacter* pcsTarget);	// 데미지 계산용
	INT32				GetPhysicalBlockRate(AgpdCharacter* pcsCharacter);								// UI 출력용
	INT32				GetPhysicalBlockRate(AgpdCharacter* pcsAttacker, AgpdCharacter* pcsTarget);		// 데미지 계산용
	INT32				GetSkillBlockRate(AgpdCharacter* pcsCharacter);									// UI 출력용
	INT32				GetSkillBlockRate(AgpdCharacter* pcsAttacker, AgpdCharacter* pcsTarget);		// 데미지 계산용
	...
	INT32				GetAdditionalEvadeRate(AgpdCharacter* pcsCharacter);							// UI 출력용
	INT32				GetAdditionalEvadeRate(AgpdCharacter* pcsAttacker, AgpdCharacter* pcsTarget);	// 데미지 계산용
	INT32				GetAdditionalDodgeRate(AgpdCharacter* pcsCharacter);							// UI 출력용
	INT32				GetAdditionalDodgeRate(AgpdCharacter* pcsAttacker, AgpdCharacter* pcsTarget);	// 데미지 계산용
