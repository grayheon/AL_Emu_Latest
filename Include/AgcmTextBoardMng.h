...
public:
	...
	sBoardDataPtr		CreateBoard				( CHAR*		szGameID , sBoardAttrPtr pAttr );
	...
	AgpmShrineBattle*		GetAgpmShrineBattle	( VOID )		{	return m_pcsAgpmShrineBattle;		}
	AgcmResourceLoader*		GetAgcmResourceLoader(VOID )		{	return m_pcsAgcmResourceLoader;		}
	...
	RwTexture*				GetVolunteerTexture	( VOID )		{	return m_ImgVolunteer;				}
	...
	DWORD					GetSHNameColor		( eShrineNameColor eType )			{	return m_ShrineNameColor[ eType ];}
	//----------------------------------------------------------------------------------------
...
private:
	...
	AgpmShrineBattle*			m_pcsAgpmShrineBattle;
	...
	DWORD						m_ShrineNameColor[ SHRINE_COLOR_COUNT ];
};
