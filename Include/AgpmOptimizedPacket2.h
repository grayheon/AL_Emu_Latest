...
public:
	...
	PVOID				MakePacketCharMove(INT32 lCID, INT8 cMoveFlag, INT8 cMoveDirection, AuPOS* pcsCurrentPOS, AuPOS *pcsDestPos, INT16 *pnPacketLength);
	...
	PVOID				MakePacketCharAllItemExceptBankCash(AgpdCharacter *pcsCharacter, INT16 *pnPacketLength);
	PVOID				MakePacketCharAllSkill(AgpdCharacter *pcsCharacter, INT16 *pnPacketLength);
