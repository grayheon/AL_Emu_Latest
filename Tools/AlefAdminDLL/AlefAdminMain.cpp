...
BOOL AlefAdminMain::OnInitDialog()
{
	...
	AgpmChatting*	ppmChatting	=	(AgpmChatting*)AlefAdminManager::Instance()->GetAdminModule()->GetModule( "AgpmChatting" );
	if( ppmChatting )
	{
		ppmChatting->SetCallbackRecvWhisperMsg( CBOnRecvChatting , this );
	}
...
BOOL AlefAdminMain::CreateViews()
{
	...
	{
// 		MessageBox("Failed to create Character View.\n");
		return FALSE;
	}
	...
	{
// 		MessageBox("Failed to create Item View.\n");
		return FALSE;
	}
	...
	{
// 		MessageBox("Failed to create Skill View.\n");
		return FALSE;
	}
	...
	{
// 		MessageBox("Failed to create Notice View.\n");
		return FALSE;
	}
	...
	{
// 		MessageBox("Failed to create Guild View.\n");
		return FALSE;
	}
	...
	{
// 		MessageBox("Failed to create User View.\n");
		return FALSE;
	}
	...
	if(!m_pTitleView || !((CWnd*)m_pTitleView)->Create(
		NULL, NULL, WS_CHILD | WS_VISIBLE | LBS_NOINTEGRALHEIGHT, rectDummy, &m_csMainTab, IDD_CHARTITLE , &cc7))
	{
// 		MessageBox("Failed to create Title View.\n");
		return FALSE;
	}
...
BOOL AlefAdminMain::ResetAllCharData()
{
	...
	m_pItemView->OnClearInventory( Inventory_ChargingInven );
...
BOOL AlefAdminMain::DisplayAdminLevel()
{
	AFX_MANAGE_STATE( AfxGetStaticModuleState() );
	CString szAdminLevel = _T("");

	szAdminLevel.Format("Admin Level : %d", AlefAdminManager::Instance()->GetAdminLevel());

	SetDlgItemText(IDC_STATIC_ADMIN_LEVEL, (LPCTSTR)szAdminLevel);
