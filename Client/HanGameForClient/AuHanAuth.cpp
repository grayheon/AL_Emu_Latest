...
int		CAuHangAuth::UpdateGamestring( char* szGameString )
{
	...
	strcpy_s( szGameStringOld, SIZE_GAMESTRING, szGameString );
...
char*	CAuHangAuth::ErrorCode( int nCode )
{
	...
	switch( nCode )
	{
	case HAN_AUTHCLI_ARGUMENT_INVALID:		strcpy_s( m_szErrorCode, 512, "HAN_AUTHCLI_ARGUMENT_INVALID" );	break;
	case HAN_AUTHCLI_INITED_ALREADY:		strcpy_s( m_szErrorCode, 512, "HAN_AUTHCLI_INITED_ALREADY" );		break;
	case HAN_AUTHCLI_INITED_NOT:			strcpy_s( m_szErrorCode, 512, "HAN_AUTHCLI_INITED_NOT" );			break;
	case HAN_AUTHCLI_INITED_FAIL:			strcpy_s( m_szErrorCode, 512, "HAN_AUTHCLI_INITED_FAIL" );			break;
	case HAN_AUTHCLI_AUTHHTTP_INITFAIL:		strcpy_s( m_szErrorCode, 512, "HAN_AUTHCLI_AUTHHTTP_INITFAIL" );	break;
	case HAN_AUTHCLI_AUTHHTTP_CONNFAIL:		strcpy_s( m_szErrorCode, 512, "HAN_AUTHCLI_AUTHHTTP_CONNFAIL" );	break;
	case HAN_AUTHCLI_REFRESHHTTP_INITFAIL:	strcpy_s( m_szErrorCode, 512, "HAN_AUTHCLI_REFRESHHTTP_INITFAIL" );break;
	case HAN_AUTHCLI_REFRESHHTTP_CONNFAIL:	strcpy_s( m_szErrorCode, 512, "HAN_AUTHCLI_REFRESHHTTP_CONNFAIL" );break;
	case HAN_AUTHCLI_NOT_IMPLEMENTED:		strcpy_s( m_szErrorCode, 512, "HAN_AUTHCLI_NOT_IMPLEMENTED" );		break;
	case HAN_AUTHCLI_AUTHHTTP_OPENREQFAIL:	strcpy_s( m_szErrorCode, 512, "HAN_AUTHCLI_AUTHHTTP_OPENREQFAIL" );break;
	case HAN_AUTHCLI_AUTHHTTP_SENDREQFAIL:	strcpy_s( m_szErrorCode, 512, "HAN_AUTHCLI_AUTHHTTP_SENDREQFAIL" );break;
	case HAN_AUTHCLI_COOKIE_SETFAIL:		strcpy_s( m_szErrorCode, 512, "HAN_AUTHCLI_COOKIE_SETFAIL" );		break;
	case HAN_AUTHCLI_GAMESTRING_IDINVALID:	strcpy_s( m_szErrorCode, 512, "HAN_AUTHCLI_GAMESTRING_IDINVALID" );break;
	case HAN_AUTHCLI_GAMESTRING_USNINVALID:	strcpy_s( m_szErrorCode, 512, "HAN_AUTHCLI_GAMESTRING_USNINVALID" );break;
	case HAN_AUTHCLI_GAMESTRING_GAMEIDINVALID:		strcpy_s( m_szErrorCode, 512, "HAN_AUTHCLI_GAMESTRING_GAMEIDINVALID" );		break;
	case HAN_AUTHCLI_GAMESTRING_SERVICECODEINVALID:	strcpy_s( m_szErrorCode, 512, "HAN_AUTHCLI_GAMESTRING_SERVICECODEINVALID" );	break;
	case HAN_AUTHCLI_CREATEINTANCEFAIL:				strcpy_s( m_szErrorCode, 512, "HAN_AUTHCLI_CREATEINTANCEFAIL" );				break;
	}
